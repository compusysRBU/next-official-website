        ...
        <div className="space-y-24 pb-24">
            {orderedEvents.map((event, index) => {
                ...
                return (
                    <motion.section
                        key={event.id}
                        className={`event-detail-section grid grid-cols-1 items-center gap-10 rounded-3xl border-2 border-zinc-950 px-6 py-10 shadow-[rgba(20,20,22,0.18)_0_0.75em_0_0] transition-transform duration-500 ${isReversed ? "hover:-translate-y-2 hover:rotate-1" : "hover:translate-y-2 hover:-rotate-1"} md:grid-cols-2 ${accent.bg}`}
